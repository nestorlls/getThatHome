...
/**
 *
 * @param {ISeekerIllustration} props - Props for seeker illustration component
 * @param {string} props.fillPrimary - Primary fill color for seeker
 * @param {string} props.fillSecondary - Secondary fill color for seeker
 * @param {string} props.fillTertiary - Tertiary fill color for seeker
 * @returns Illlustration for seeker
 */

export const SeekerIllustration: FC<ISeekerIllustration> = ({
  fillPrimary,
  fillSecondary,
  fillTertiary,
}): JSX.Element => {
  return (
    ...
    >
      <g id="freepik--background-complete--inject-2">
        ...
        ></path>
        <path
          d="M384.63,184.69,449,185s-6.1-14-19.13-14c-9.93,0-10.37,6.18-16.34,7.95S395,169.9,384.63,184.69Z"
          style={{ fill: '#ebebeb' }}
        ></path>
        <path
      ...
      <g id="freepik--Buildings--inject-2">
        ...
        ></path>
        <path
          d="M297.2,279c0,.2-6.09.36-13.6.36S270,279.23,270,279s6.08-.35,13.6-.35S297.2,278.84,297.2,279Z"
          style={{ fill: fillSecondary }}
        ></path>
        <path
      ...
      <g id="freepik--House--inject-2">
        ...
        ></polygon>
        <g style={{ opacity: 0.2 }}>
          <polyline points="321.61 399 321.61 369.27 338.83 369.27 338.83 399"></polyline>
        </g>
        <rect
          x="349.16"
          y="368.43"
        ...
        ></rect>
        <path
          d="M365.44,323.66a3.63,3.63,0,1,1-3.63-3.63A3.64,3.64,0,0,1,365.44,323.66Z"
          style={{ fill: '#fff', opacity: 0.7000000000000001 }}
        ></path>
        <polygon
          points="335.92 319.21 340.5 313.56 340.5 299.97 330.91 299.97 330.91 319.31 335.92 319.21"
          style={{ fill: fillPrimary }}
        ></polygon>
        <polygon
          points="335.92 319.21 335.92 299.97 340.5 299.97 340.5 313.56 335.92 319.21"
          style={{ opacity: 0.2 }}
        ></polygon>
        <rect
          x="329.84"
        ...
        ></rect>
        <polygon
          points="274.32 330.13 274.32 332.12 348.02 332.12 348.02 330.11 274.32 330.13"
          style={{ fill: fillPrimary }}
        ></polygon>
        <polygon
          points="348.02 332.12 361.81 312.77 361.85 310.57 348.07 330.13 348.02 332.12"
          style={{ fill: '#7E57C2#' }}
        ></polygon>
        <rect
          x="376.4"
      ...
      <g id="freepik--Character--inject-2">
        ...
        ></path>
        <path
          d="M138.07,182.22s3-20.1-24.66-20.47c-30.94-.41-36.52,26-31.22,39.91l15.38-15.24Z"
          style={{ fill: fillTertiary }}
        ></path>
        <path
        ...
        ></path>
        <path
          d="M131.86,203.59a1.74,1.74,0,1,1-1.53-2A1.76,1.76,0,0,1,131.86,203.59Z"
          style={{ fill: '#263238' }}
        ></path>
        <path
        ...
        ></path>
        <path
          d="M113.29,201.81a1.74,1.74,0,1,1-3.45-.37,1.74,1.74,0,1,1,3.45.37Z"
          style={{ fill: '#263238' }}
        ></path>
        <path
        ...
        ></path>
        <path
          d="M114.39,238.29a33.3,33.3,0,0,1-17.18-8.13s3.36,10.92,16.93,11.82Z"
          style={{ fill: '#eb996e' }}
        ></path>
        <path
        ...
        ></path>
        <path
          d="M88,198.79c-.21-.15-7.88-3.46-10.07,5.57s8.29,8.11,8.37,7.85S88,198.79,88,198.79Z"
          style={{ fill: '#ffbe9d' }}
        ></path>
        <path
        ...
        ></path>
        <path
          d="M197.25,285.34s5.67-13.47-2-12c-11.75,2.24-10,13.67-10,13.67Z"
          style={{ fill: '#eb996e' }}
        ></path>
        <path
